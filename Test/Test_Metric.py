...
def get_p_at_1 (patches, index, ref):
    ...
    stsim_scores_tf = metric_tf.CWSSIM(batch_ref, batch_eval, height=3, orientations=4, full=False)
...
if __name__ == "__main__":
    ...
    patches = load_patches('Dataset\\CUReT_Data', patch_size=patch_size, n_patches=3, random=True, cut_size=(140,340,200,500), preprocess_limit=0)
